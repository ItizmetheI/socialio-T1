      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col items-center">
        ...
        <div className="w-full mb-32">
           <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
             ...
             <a href="/contact" className="hidden md:flex bg-white/5 hover:bg-white/10 text-white border border-white/20 px-6 py-3 rounded-full font-sans font-bold text-sm items-center gap-2 transition-colors">
        ...
        <div className="w-full max-w-5xl mx-auto relative group">
          ...
          <div className="relative bg-surface-container border border-white/10 p-12 md:p-20 rounded-[3rem] text-center overflow-hidden">
            ...
            <a href="/contact" className="relative z-10 inline-flex px-8 py-5 bg-white text-black font-mono text-sm font-bold uppercase tracking-widest hover:bg-primary hover:text-white transition-all duration-300 rounded-xl shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_40px_rgba(215,183,255,0.4)] hover:-translate-y-1 items-center gap-3">
