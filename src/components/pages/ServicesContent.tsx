...
export default function ServicesContent() {
  ...
  return (
    <div className="min-h-screen bg-background relative selection:bg-primary/30 text-surface-container-highest">
      ...
      <div className="pt-32 max-w-7xl mx-auto px-6 mb-24 relative z-10 text-on-surface">
        ...
        >
           ...
           <a href="/contact" className="shrink-0 relative z-10 bg-white text-black px-8 py-4 rounded-xl font-bold hover:bg-gray-200 transition-colors shadow-xl flex items-center gap-3">
