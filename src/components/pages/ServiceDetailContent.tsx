import { CheckCircle2, ChevronDown, ShoppingCart, ShieldCheck, Star, TrendingUp, Target, Zap, Users, LineChart } from "lucide-react";
import { useState, useRef } from "react";
import { motion, useInView } from "motion/react";
import { useCart } from "../../hooks/useCart";
import AutoplayVideo from "../AutoplayVideo";
import { shortFormVideos, ugcVideos, blogImages, socialImages } from "../../data/media";
import { addOnsData } from "../../data/services";
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-16 items-start mb-32">
          ...
          <div className="xl:col-span-7 flex flex-col gap-20">
            ...
            <div className="w-full text-center bg-surface-container border border-white/10 p-12 rounded-3xl relative overflow-hidden">
              ...
              <a href="/contact" className="inline-block px-8 py-4 bg-white text-black font-mono text-xs font-bold uppercase tracking-widest hover:bg-primary hover:text-white transition-colors duration-300 rounded">
