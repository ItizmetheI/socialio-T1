  ...
  return (
    <div className="min-h-screen pt-32 pb-24 px-6 max-w-7xl mx-auto text-on-surface">
      ...
      <div className="mt-24 max-w-3xl mx-auto text-center bg-surface-container border border-white/10 p-12 rounded-3xl">
        ...
        <a href="/contact" className="inline-block px-8 py-4 bg-white text-black font-mono text-xs font-bold uppercase tracking-widest hover:bg-primary hover:text-white transition-colors duration-300 rounded shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(215,183,255,0.3)]">
