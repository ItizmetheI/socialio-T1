  ...
  return (
    <div className="min-h-screen bg-background flex flex-col md:flex-row relative overflow-hidden">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center px-8 py-16 md:px-16 lg:px-24 z-10">
        <a href="/" className="flex items-center gap-2 mb-16 md:absolute md:top-8 md:left-12">
        ...
        >
          ...
          <div className="mt-8">
            <a href="/contact" className="text-on-surface-variant hover:text-white text-sm font-sans underline underline-offset-4 transition-colors">
